...
# Creating two columns, with width 0.1 and 0.9
...
# Providing information on where the data is coming from. I could also include the datetime when the dashboard is refreshed for future use.
with col8:
...
with col17:
    ...
    st.dataframe(df_organic_reorder.style.format({"% of reorder": "{:.2f}%"}), height=250, use_container_width=True)
